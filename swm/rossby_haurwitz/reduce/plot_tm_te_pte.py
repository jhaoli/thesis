...
file0   = "rh4.swm.360x181.dt60.h0.nc"
file1   = "rh4.swm.360x181.dt60.vordamp.h0.nc"

day = 90
f0    = Dataset(file0, 'r')
tm0   = f0.variables['tm'][0:day]
te0   = f0.variables['te'][0:day]
tpe0  = f0.variables['tpe'][0:day]
tim   = f0.variables['time'][0:day]

f1   = Dataset(file1, 'r')
tm1  = f1.variables['tm'][0:day]
te1  = f1.variables['te'][0:day]
tpe1 = f1.variables['tpe'][0:day]
...
ax2.legend(frameon=False, fontsize=12, loc=(0.02,0.4))
...
ax3.legend(frameon=False, fontsize=12, loc=(0.02, 0.4))
...
ax4.legend(frameon=False, fontsize=12, loc=(0.02,0.4))
...
ax5.legend(frameon=False, fontsize=12, loc=(0.02,0.1))
