...
x = np.arange(len(tim))
ax0.plot(x[0::4], (tm0[0::4] - tm0[0]) / tm0[0], label='no reduce, 6s', linestyle='-', marker='o', color='red', linewidth=2)
ax0.plot(x[0::4], (tm2[0::4] - tm2[0]) / tm2[0], label='reduce, 6s'   , linestyle='--', marker='', color='blue', linewidth=2)
ax0.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
#ax0.set_ylim(-5E-12,0.2E-12)
ax0.minorticks_on()
ax0.set_xticks(np.arange(0,len(tim),4))
...
ax1.plot(x, (tm1 - tm1[0]) / tm1[0], label='reduce, 60s', color='blue', linewidth=2)
ax1.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
ax1.minorticks_on()
ax1.set_xticks(np.arange(0,len(tim),4))
...
ax2.plot(x[0::4], (te0[0::4] - te0[0]) / te0[0], label='no reduce, 6s', linestyle='-', marker='o', color='red', linewidth=2)
ax2.plot(x, (te2 - te2[0]) / te2[0], label='reduce, 6s'  , linestyle='--', marker='', color='blue', linewidth=2)
ax2.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
ax2.minorticks_on()
ax2.set_ylim(-4E-11,1E-11)
ax2.set_xticks(np.arange(0,len(tim),4))
ax2.set_xticklabels(np.arange(0,11,1))
...
ax3.plot(x, (te1 - te1[0]) / te1[0], label='reduce, 60s', color='blue', linewidth=2)
ax3.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
ax3.set_ylim(-4E-9,1E-9)
ax3.minorticks_on()
ax3.set_xticks(np.arange(0,len(tim),4))
ax3.set_xticklabels(np.arange(0,11,1))
ax3.legend(frameon=False, fontsize=12, loc=(0.02, 0.02))
ax3.grid(linestyle='dotted', linewidth=0.4)

ax4= fig.add_subplot(3,2,5)
ax4.plot(x[0::4], (tpe0[0::4] - tpe0[0]) / tpe0[0], label='no reduce, 6s', linestyle='-', marker='o', color='red', linewidth=2)
ax4.plot(x, (tpe2 - tpe2[0]) / tpe2[0], label='reduce, 6s'   , linestyle='--', marker='', color='blue', linewidth=2)
ax4.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
ax4.minorticks_on()
ax4.set_xticks(np.arange(0,len(tim),4))
ax4.set_xticklabels(np.arange(0,11,1))
...
ax5.plot(x, (tpe1 - tpe1[0]) / tpe1[0], label='reduce, 60s', color='blue',linewidth=2)
ax5.ticklabel_format(style='sci', axis='y', scilimits=(2,1))
#a1.set_ylim(-1.0E-05,2E-06)
ax5.minorticks_on()
ax5.set_xticks(np.arange(0,len(tim),4))
ax5.set_xticklabels(np.arange(0,11,1))
ax5.legend(frameon=False, fontsize=12, loc=(0.02,0.02))
ax5.set_xlabel('Time (days)')
ax5.grid(linestyle='dotted', linewidth=0.4)

figname = './tm_te_tpe_cross_pole_reduce.png'
