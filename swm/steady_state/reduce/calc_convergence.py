...
f2p0 = Dataset('./ss.swm.180x91.reduce.dt240.day12.h0.nc', 'r')
f1p0 = Dataset('./ss.swm.360x181.reduce.dt120.day12.h0.nc','r')
f0p5 = Dataset('./ss.swm.720x361.reduce.dt60.day12.h0.nc', 'r')
f0p25 = Dataset('./ss.swm.1440x721.reduce.dt30.day12.h0.nc', 'r')
...
ax.set_title('Day 12')
figname = './convergence_steday_state_reduce.png'
